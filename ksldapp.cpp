 ...
 *
 S PD*X-License-Identifier: GPL-2.0-or-later
 */
#include "ksldapp.h"
...
namespace ScreenLocker
{
    ...
    void KSldApp::initialize()
    {
        ...
        // session backend selection: seatd if available, otherwise null backend
        #if HAVE_SEATD
        m_backend = new SeatdBackend();
        #else
        m_backend = new NullBackend();
        #endif
        ...
        // Solid suspend integration (hybrid path, no logind)
